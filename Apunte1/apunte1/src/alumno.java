class Alumno{
    ...
    String domicilioCiudad, int numeroTelefono, String usuario, String contrasenia){
     ...
     public String toString(){
        return "Nombre y apellido: " +nombre+ " "+apellido+"| Legajo: "+legajo+ "| "+tipoDNI+": "+numeroDNI+"| Domicilio: "+domicilioCalle+" "+domicilioNumero+", "+domicilioCiudad+"| Telefono: "+numeroTelefono+ "| Usuario: "+usuario;
     }
